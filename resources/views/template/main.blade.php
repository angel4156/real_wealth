...
<head>
    ...
    <title>@yield('title') | Real Wealth</title>
    ...
    <link rel="stylesheet" href="/assets/css/aboutImage.css">
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="/did_know" class="nav-link">
                                <i class="nav-icon fa-solid fa-box"></i>
                                <p>
                                    Did_know
                                </p>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2023 <a href="/dashboard">Real Wealth</a>.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
